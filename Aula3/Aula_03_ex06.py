...
hist_item_equalized =  compute_histogram(equalized,histSize, histRange)

histImageWidth = 512
histImageHeight = 512
color = (125)
histImage =  histogram2image(hist_item, histSize, histImageWidth, histImageHeight, color)
histequalized =  histogram2image(hist_item_equalized, histSize, histImageWidth, histImageHeight, color)

cv2.imshow('colorhist', histImage)
cv2.imshow('equalized', histequalized)
cv2.waitKey(0)
